...
//                        setPathState(blue21.PathState.collection);
//                    }
//                }
//                break;
//
...
//                    theWheelOfTheOx.setPower(-1);
//                }
//                if (!follower.isBusy() && gateCollectionStarted && readyToLeaveGateCollection()) {
...
//                    theWheelOfTheOx.setPower(-1);
//                }
//                if (!follower.isBusy() && gateCollectionAgainStarted && readyToLeaveGateCollection()) {
