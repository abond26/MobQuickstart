...
public class far9red extends OpMode {
    ...
    private final Pose collect2StartAgainAgain = new Pose(125, 9, Math.toRadians(0));
    private final Pose collect2EndAgainAgain = new Pose(135, 9, Math.toRadians(0));
