...
public class far6red extends OpMode {
    ...
    private final Pose shootPose1 = new Pose(89, 17, Math.toRadians(72.5));
    ...
    private final Pose shootPose2 = new Pose( 89, 17, Math.toRadians(71));
    ...
    private final Pose shootBall3 = new Pose(89, 17, Math.toRadians(71));
    private final Pose park = new Pose(103, 22, Math.toRadians(72));
    ...
    public void buildPaths() {
        ...
        parking=follower.pathBuilder()
                .addPath(new BezierLine(shootPose2, park))
                .setLinearHeadingInterpolation(shootPose2.getHeading(), park.getHeading())
                .build();
        ...
        switch (pathState) {
            ...
            case actuallyshoot1:
                ...
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds()>4){
                    ...
                    if (pathTimer.getElapsedTimeSeconds()>6.5) {
                        setPathState(far6red.PathState.collection);
                    }
                }
                break;
            case gotocollect:
            ...
            case collection:
                ...
                if (!follower.isBusy()) {
                    ...
                    setPathState((far6red.PathState.shoot));
                }
                break;
            case shoot:
                // Continuously adjust based on limelight during shooting
...
//                    //theWheelOfTheOx.setPower(0.005);
//                    //hood.setPosition(0.225);
//                    setPathState((far6red.PathState.collectAgainAgainAgain));
//                }
//                break;
...
//                    //theWheelOfTheOx.setPower(0.005);
//                    //hood.setPosition(0.225);
//                    setPathState((far6red.PathState.shootAgain));
//                }
//                break;
//            case shootAgain:
//                // Continuously adjust based on limelight during shooting
