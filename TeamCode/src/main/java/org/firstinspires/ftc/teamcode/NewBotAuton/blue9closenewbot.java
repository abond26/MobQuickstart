...
public class blue9closenewbot extends OpMode {
    ...
    private final Pose collect3start=new Pose(52, 82, Math.toRadians(180));
    ...
    private final Pose park = new Pose(35, 84, Math.toRadians(141));
        ...
        switch (pathState) {
            ...
            case actuallyshoot1:
                ...
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds()>2){
                    ...
                    if (pathTimer.getElapsedTimeSeconds()>3.5) {
                        setPathState(blue9closenewbot.PathState.collection);
                    }
                }
                break;
            case gotocollect:
            ...
            case collection:
                ...
                if (!follower.isBusy()) {
                    ...
                    setPathState((blue9closenewbot.PathState.shoot));
                }
                break;
            case shoot:
                // Continuously adjust based on limelight during shooting
            ...
            case collectAgainEnd:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1) {
                    ...
                    setPathState((blue9closenewbot.PathState.shootAgain));
                }
                break;
            case shootAgain:
                // Continuously adjust based on limelight during shooting
...
//                    //theWheelOfTheOx.setPower(0.005);
//                    //hood.setPosition(0.225);
//                    setPathState((blue9closenewbot.PathState.shootAgainAgain));
//                }
//                break;
