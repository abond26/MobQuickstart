...
/**
 * Blue-alliance mirror of {@link redGate}: poses mirrored across field center (x' = 144 − x,
 * heading' = π − heading). Goal / hood / pipeline use {@link BlueUniversalConstants}.
 */
...
public class blueGate extends OpMode implements BlueUniversalConstants {
    Pose target = BlueUniversalConstants.target;
    Pose sillyTarget;
    ...
    /** Mirrored from redGate (x' = 144 − x, θ' = π − θ). */
    private final Pose startPose =
            new Pose(31.78276455368695, 136.97551020408164, Math.PI - Math.toRadians(-90));
    private final Pose shootPose1 = new Pose(65, 79, Math.PI - Math.toRadians(40));
    private final Pose collect1thing = new Pose(18, 58, Math.PI);
    private final Pose goToCollect1ControlPoint = new Pose(52.265, 60.091);
    private final Pose shootPose2 = new Pose(65, 79, Math.PI - Math.toRadians(25));
    private final Pose gateCollect1 = new Pose(13.5, 62, Math.toRadians(142));
    private final Pose option1 = new Pose(13, 61, Math.PI - Math.toRadians(45));
    private final Pose option2 = new Pose(7, 55, Math.PI - Math.toRadians(90));

    private final Pose shootBall3 = new Pose(65, 79, Math.PI - Math.toRadians(25));
    private final Pose inBetween2 = new Pose(44, 62, Math.PI - Math.toRadians(202.5));
    private final Pose gateCollect2 = new Pose(15.5, 62, Math.PI - Math.toRadians(205));
    private final Pose shootBall4 = new Pose(60, 75, Math.PI - Math.toRadians(230));
    private final Pose gateCollect3 = new Pose(15.5, 62, Math.PI - Math.toRadians(205));
    private final Pose shootBall5 = new Pose(49, 87, Math.PI - Math.toRadians(230));
    private final Pose collect3end = new Pose(24, 85, Math.PI);
    private final Pose collect3ControlPoint = new Pose(41.02, 84.857);
    private final Pose shootBall6 = new Pose(55, 120, Math.PI - Math.toRadians(33));
    private final Pose park = new Pose(41, 84, Math.PI - Math.toRadians(226));

    private PathChain shoot1, Turn, goToCollect1, shoot3ToGate, collect1, shoot2, GateCollect3,
            shoot6, InBetween1, InBetween2, GateCollect1, GateCollect2, shoot3, awayfromGate,
            goToCollect3, collect3, shoot4, goToGate, openGate, goToCollect4, collect4, shoot5,
            parking;
        ...
        collect1 =
                follower.pathBuilder()
                        ...
                        .setLinearHeadingInterpolation(
                                shootPose1.getHeading(), collect1thing.getHeading())
                        .build();
    ...
    public void statePathUpdate() {
        switch (pathState) {
            ...
            case GateCollection:
                ...
                boolean ready = full || openTimer.getElapsedTimeSeconds() > 3;
