...
public class blue9farnewbot extends OpMode {
    ...
    private final Pose startPose = new Pose(57, 7, Math.toRadians(90));                    // red (87, 7, 90)
    private final Pose shootPose1 = new Pose(55, 15, Math.PI - Math.toRadians(72));         // red (89, 15, 72)
    ...
    private final Pose collect1thing = new Pose(13, 36, Math.PI);                           // red (131, 36, 0)
    private final Pose shootPose2 = new Pose(55, 15, Math.PI - Math.toRadians(66));         // red (89, 15, 66)

    private final Pose collect2ControlPoint = new Pose(37.47138964577657, 8.239782016348768); // red (106.53..., 8.24...)

    private final Pose collect2End = new Pose(9, 4, Math.PI);                              // red (135, 4, 0)
    private final Pose shootBall3 = new Pose(55, 10, Math.PI - Math.toRadians(64));         // red (89, 10, 64)
