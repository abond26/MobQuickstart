...
public class red18closenewbot extends OpMode {
    ...
    private final Pose gateCollect1 = new Pose( 128.5, 61.5, Math.toRadians(25));
    ...
    private final Pose gateCollect2 = new Pose( 128.75, 61.5, Math.toRadians(25));
    private final Pose shootBall4 = new Pose(89, 88, Math.toRadians(47));
    private final Pose gateCollect3 = new Pose( 128.75, 61.5, Math.toRadians(25));
