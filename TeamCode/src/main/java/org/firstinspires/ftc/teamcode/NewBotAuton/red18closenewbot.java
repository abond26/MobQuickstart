...
public class red18closenewbot extends OpMode {
    ...
    private final Pose gateCollect1 = new Pose(127, 61, Math.toRadians(30));
    ...
    private final Pose gateCollect2 = new Pose(127, 61, Math.toRadians(30));
    private final Pose shootBall4 = new Pose(89, 88, Math.toRadians(47));
    private final Pose gateCollect3 = new Pose(127, 61, Math.toRadians(30));
