...
@Autonomous(name = "Test 12 blue close - facing tag", group = "test")
public class close12blueTest extends OpMode {
    ...
    private static final double INTAKE_DRIVE_POWER = 0.75; // tune this
    ...
    // TEST: Shooting poses now face the AprilTag (24.4, 126.7)
    // shootPose1 (52, 82): angle to tag = atan2(44.7, -27.6) ≈ 121.8°
    private final Pose shootPose1 = new Pose(52, 82, Math.toRadians(121.8));
    ...
    // shootPose2 (52, 84): angle to tag = atan2(42.7, -27.6) ≈ 122.9°
    private final Pose shootPose2 = new Pose( 52, 84, Math.toRadians(122.9));
...
//test
    ...
    // shootBall3 (52, 84): same as shootPose2 = 122.9°
    private final Pose shootBall3 = new Pose(52, 84, Math.toRadians(122.9));
    ...
    // shootBall4 (52, 84): same as shootPose2 = 122.9°
    private final Pose shootBall4 = new Pose(52, 84, Math.toRadians(122.9));
    ...
    public void statePathUpdate() {
        switch (pathState) {
            case start:
                ...
                // shootPose1 (52, 82) is ~52.53\" from tag ⇒ ~1680.9
                launcher.setVelocity(1681); // was 2050
            ...
            case actuallyshoot1:
                ...
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds()>2){
                    ...
                    if (pathTimer.getElapsedTimeSeconds()>3.5) {
                        setPathState(close12blueTest.PathState.collection);
                    }
                }
                break;
            case gotocollect:
            ...
            case collection:
                ...
                if (!follower.isBusy()) {
                    ...
                    launcher.setVelocity(1680); // was 1850
                    hood.setPosition(0.2541);   // was 0.315
                    theWheelOfTheOx.setPower(1);
                    tree.setPower(1);
            ...
            case collectAgainEnd:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1) {
                    launcher.setVelocity(1680); // was 1775
                    follower.followPath(collect2);
                    tree.setPower(1);
                    hood.setPosition(0.2541);   // was 0.325
                    theWheelOfTheOx.setPower(1);
                    setPathState((close12blueTest.PathState.shootAgain));
                }
                break;
            case shootAgain:
                // Continuously adjust based on limelight during shooting
            ...
            case collectAgainAgainEnd:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1) {
                    launcher.setVelocity(1680); // was 1825
                    follower.followPath(collect3);
                    tree.setPower(1);
                    hood.setPosition(0.2541);   // was 0.325
                    theWheelOfTheOx.setPower(1);
                    setPathState((close12blueTest.PathState.shootAgainAgain));
                }
                break;
