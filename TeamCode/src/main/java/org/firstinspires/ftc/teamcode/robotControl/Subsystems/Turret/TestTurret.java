...
public class TestTurret extends Turret {
    ...
    public static PIDFCoefficients FLYWHEEL_PID_CLOSE = new PIDFCoefficients(0.0022, 0, 0.00005, 0.000077);
    public static PIDFCoefficients FLYWHEEL_PID_FAR = new PIDFCoefficients(0.0029, 0.0003, 0.00002, 0.000077);
    public static double SWITCH_PID_DIST = 100;
